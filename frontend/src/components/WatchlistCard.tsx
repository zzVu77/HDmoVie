...
export default function WatchlistCard({ title, description, isPublic, movies }: WatchlistProps) {
  ...
  return (
    <div
      className={`group w-full max-h-[144px] overflow-hidden flex flex-row items-start rounded-lg border-none shadow-none p-3 bg-secondary-dark bg-no-repeat bg-cover cursor-pointer transition duration-300 hover:shadow-[0_0_7px_0px] hover:shadow-primary-yellow`}
