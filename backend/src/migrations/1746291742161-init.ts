...
export class Init1746291742161 implements MigrationInterface {
  name = 'Init1746291742161'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`blog_media\` (\`id\` varchar(36) NOT NULL, \`url\` text NOT NULL, \`blogId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    )
    await queryRunner.query(
