...
export class Init1745120168644 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`movies_genres\` (\`movieId\` varchar(36) NOT NULL, \`genreId\` varchar(36) NOT NULL, INDEX \`IDX_4729d9b8d47986f936cb5e9540\` (\`movieId\`), INDEX \`IDX_ef4fe5a96b6f83e9472bdaefbc\` (\`genreId\`), PRIMARY KEY (\`movieId\`, \`genreId\`)) ENGINE=InnoDB`,
    )
    await queryRunner.query(
      `CREATE TABLE \`movies_casts\` (\`movieId\` varchar(36) NOT NULL, \`castId\` varchar(36) NOT NULL, INDEX \`IDX_6f28c1a0e1dd6a646ae2d074ff\` (\`movieId\`), INDEX \`IDX_9526b6488b6897f404194584d8\` (\`castId\`), PRIMARY KEY (\`movieId\`, \`castId\`)) ENGINE=InnoDB`,
    )
    await queryRunner.query(
      `CREATE TABLE \`watchlists_movies\` (\`watchlistId\` varchar(36) NOT NULL, \`movieId\` varchar(36) NOT NULL, INDEX \`IDX_559f5f7d9dbec108467acd1f9a\` (\`watchlistId\`), INDEX \`IDX_7f48c6d34503bd92b5fd66b06a\` (\`movieId\`), PRIMARY KEY (\`watchlistId\`, \`movieId\`)) ENGINE=InnoDB`,
    )
    await queryRunner.query(
      `CREATE TABLE \`blogs_tags\` (\`blogId\` varchar(36) NOT NULL, \`tagId\` varchar(36) NOT NULL, INDEX \`IDX_377b848c1bf364f261f48c68bc\` (\`blogId\`), INDEX \`IDX_30d6656ad4b7979788696aa470\` (\`tagId\`), PRIMARY KEY (\`blogId\`, \`tagId\`)) ENGINE=InnoDB`,
    )
    await queryRunner.query(
      `CREATE TABLE \`like_interactions_users\` (\`likeInteractionId\` varchar(36) NOT NULL, \`userId\` varchar(36) NOT NULL, INDEX \`IDX_fd90b482d7dd9f64fcdee0bbdd\` (\`likeInteractionId\`), INDEX \`IDX_9f0c39f25b3ac84e71187a6f34\` (\`userId\`), PRIMARY KEY (\`likeInteractionId\`, \`userId\`)) ENGINE=InnoDB`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`movies_genres\` ADD CONSTRAINT \`FK_4729d9b8d47986f936cb5e9540e\` FOREIGN KEY (\`movieId\`) REFERENCES \`movies\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    )
    await queryRunner.query(
      `ALTER TABLE \`movies_genres\` ADD CONSTRAINT \`FK_ef4fe5a96b6f83e9472bdaefbc5\` FOREIGN KEY (\`genreId\`) REFERENCES \`genres\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    )
    await queryRunner.query(
      `ALTER TABLE \`movies_casts\` ADD CONSTRAINT \`FK_6f28c1a0e1dd6a646ae2d074ff8\` FOREIGN KEY (\`movieId\`) REFERENCES \`movies\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    )
    await queryRunner.query(
      `ALTER TABLE \`movies_casts\` ADD CONSTRAINT \`FK_9526b6488b6897f404194584d82\` FOREIGN KEY (\`castId\`) REFERENCES \`casts\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    )
    await queryRunner.query(
      `ALTER TABLE \`watchlists_movies\` ADD CONSTRAINT \`FK_559f5f7d9dbec108467acd1f9ac\` FOREIGN KEY (\`watchlistId\`) REFERENCES \`watchlists\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    )
    await queryRunner.query(
      `ALTER TABLE \`watchlists_movies\` ADD CONSTRAINT \`FK_7f48c6d34503bd92b5fd66b06a0\` FOREIGN KEY (\`movieId\`) REFERENCES \`movies\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    )
    await queryRunner.query(
      `ALTER TABLE \`blogs_tags\` ADD CONSTRAINT \`FK_377b848c1bf364f261f48c68bc3\` FOREIGN KEY (\`blogId\`) REFERENCES \`blogs\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    )
    await queryRunner.query(
      `ALTER TABLE \`blogs_tags\` ADD CONSTRAINT \`FK_30d6656ad4b7979788696aa470c\` FOREIGN KEY (\`tagId\`) REFERENCES \`tags\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    )
    await queryRunner.query(
      `ALTER TABLE \`like_interactions_users\` ADD CONSTRAINT \`FK_fd90b482d7dd9f64fcdee0bbdd0\` FOREIGN KEY (\`likeInteractionId\`) REFERENCES \`like_interactions\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    )
    await queryRunner.query(
      `ALTER TABLE \`like_interactions_users\` ADD CONSTRAINT \`FK_9f0c39f25b3ac84e71187a6f34c\` FOREIGN KEY (\`userId\`) REFERENCES \`registeredUsers\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    )
  }
