...
blogRouter.post('/', authenticateToken, isAdmin, createBlogMiddleware, (req, res) =>
  blogController.createBlog(req, res),
)
blogRouter.delete('/:blogId', authenticateToken, isAdmin, (req, res) => blogController.deleteBlog(req, res))
